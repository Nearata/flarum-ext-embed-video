...
export default class EmbedVideoModal extends Modal<Attrs> {
  ...
  oninit(vnode: any) {
    ...
    extensions.forEach((i) => {
      if (app.forum.attribute(i.attributeName)) {
        const name = i.attributeName.toLowerCase().replace("embedvideo", "");
        ...
        m(".Form", [
          m(".Form-group", [
            ...
            m(Select, {
              ...
              onchange: (value: string) => {
                ...
                this.qualities = this.pointersData[value].qualities;
              },
          ...
          m(".Form-group", [
            ...
            m("input", {
              ...
              disabled: this.loading,
              oninput: (e: any) =>
                (this.pointersData[this.currentPointer].url = e.target.value),
              autocomplete: "off",
          ...
          m(".Form-group", [
            ...
            m(Select, {
              ...
              onchange: (value: string) =>
                (this.pointersData[this.currentPointer].type = value),
              disabled: this.loading,
            }),
          ]),
          m(".Form-group", [
            m(
              Switch,
              {
                onchange: (value: boolean) =>
                  (this.pointersData[this.currentPointer].live = value),
                state: this.pointersData[this.currentPointer].live,
                disabled: this.loading,
              },
              trans("live_mode")
            ),
              ...
              ? [
                  m(
                    Button,
                    {
                      ...
                      disabled: this.loading,
                      onclick: (_: any) => {
                        const n = Object.keys(this.pointers).length;
                        const index = `#${n}`;

                        this.pointers[index] = index;
                        this.pointersData[index] = this.pointersData["new"];

                        this.pointersData["new"] = new PointerState();

                        this.qualities = this.pointersData["new"].qualities;
              ...
              : [
                  m(
                    Button,
                    {
                      ...
                      disabled: this.loading,
                      onclick: (_: any) => {
                        delete this.pointers[this.currentPointer];
                        delete this.pointersData[this.currentPointer];

                        this.qualities = this.pointersData["new"].qualities;

                        const keys = Object.keys(this.pointers).filter(
                          (i) => i !== "new"
                        );
                        ...
                        for (const i of keys) {
                          this.pointers[`#${count}`] = `#${count}`;
                          this.pointersData[`#${count}`] = this.pointersData[i];
            ...
            ? [
                m(".Form-group", [
                  ...
                  m(Select, {
                    ...
                    onchange: (value: string) => (this.currentQuality = value),
                    disabled: this.loading,
                  }),
                ]),
                m(".Form-group", [
                  ...
                  m("input", {
                    ...
                    disabled: this.loading,
                    oninput: (e: any) =>
                      (this.pointersData[this.currentPointer].qualitiesData[
                        this.currentQuality
                      ].name = e.target.value),
                    autocomplete: "off",
                    value:
                  ...
                  this.currentQuality === "new"
                    ? m(
                        Button,
                        {
                          ...
                          onclick: (_: any) => {
                            const quality =
                              this.pointersData[this.currentPointer]
                                .qualitiesData["new"];
                            const quality1 = new QualityState();

                            quality1.name = quality.name;
                            quality1.type = quality.type;
                            quality1.url = quality.url;

                            const n = Object.keys(this.qualities).length;

                            this.pointersData[this.currentPointer].qualities[
                              `#${n}`
                            ] = `#${n}`;
                            this.pointersData[
                              this.currentPointer
                            ].qualitiesData[`#${n}`] = quality1;
                    ...
                    : m(
                        Button,
                        {
                          ...
                          onclick: (_: any) => {
                            delete this.pointersData[this.currentPointer]
                              .qualities[this.currentQuality];
                            delete this.pointersData[this.currentPointer]
                              .qualitiesData[this.currentQuality];
  ...
  onsubmit(e: any) {
    ...
    for (const i of pKeys) {
      ...
      const qKeys = Object.keys(data.qualities).filter((i) => i !== "new");
